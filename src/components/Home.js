...
function Home() {
  return (
    <div className="homebody mx-6 px-6">
      {Header("Our Mission")}
      ...
      <div className="parent container" id="parent-box">
        ...
        <div className="child d-flex col-md-6 col-lg-3 py-3">
          <div className="descr">
            ...
            <br></br>
            <strong className="bold-descr">After all, achieving zero hunger is not just a possibility; it's an imperative we can realize together.</strong></div>
        </div>
      </div>
      <div>
      ...
      <div className="text-center" id="button-forquiz">
